        ...
        <>
                <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Buy cUSD with {userSessionData?.user.currency} from M-Pesa and get a 2% cashback in cUSD pai directly to your MiniPay wallet</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
                          <form
