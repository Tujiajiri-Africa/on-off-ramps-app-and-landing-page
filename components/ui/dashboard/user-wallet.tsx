...
export function UserWallet(){
    ...
    const [cryptoBalance, setCryptoBalance] = useState<number|undefined>(0);
                                ...
                                <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-1">
                                    ...
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                        ...
                                        <CardContent>
                                            ...
                                            <Button
                                                className="w-full bg-transparent text-primary-foreground dark:text-white dark:hover:bg-[#4B49AC]/30 hover:bg-[#4B49AC]/95 hover:text-white"
                                            >
