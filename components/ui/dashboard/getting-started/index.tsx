          ...
          <div className="col-span-2">
            ...
            {/* <h1 className="text-3xl font-bold text-white mb-4">
              ...
              {/* <p className="text-lg text-white mb-8">
                ...
                <p className="text-md text-white mb-8">
                  {/* Start buying and selling crypto, create and manage invoices with ease. */}
                    Start accumulating rewards in cUSD and {userSessionData?.user.currency} when you buy and sell cUSD from us via MiniPay. You get 2% cachback for every cUSD purchase.
