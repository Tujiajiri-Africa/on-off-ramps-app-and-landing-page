    ...
    <div className="p-5 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
      {/* Hero Title */}
        <h1 className="py-10 text-3xl sm:text-7xl font-semibold tracking-wide leading-tight text-white">
            ...
            Experience <span className="text-[#00BF63]">secure</span> and <span className="text-[#00BF63]">compliant</span> crypto onboarding <span className="text-[#06F0FF]"> like a pro</span>
        </h1>
      {/* Starting Price */}
