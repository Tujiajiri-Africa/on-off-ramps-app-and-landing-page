   ...
   return (
    ...
    <div className="mx-auto w-full p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {date} <a href="https://ajirapay.finance" className="hover:underline">Ajirapay Finance</a>. All Rights Reserved.
          </span>
