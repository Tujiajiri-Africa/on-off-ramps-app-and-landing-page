...
export function ContactPageV2(){
    return (<>
    <div className="bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50  px-2 py-10 content-center items-center h-full lg:h-screen" id="contact-us">
        <div className='sm:w-[80%] md:pt-1.5  lg:pt-1.5 w-[98%] mx-auto bg-inherit content-center items-center'>
       ...
       <p className="mt-1.5 text-sm leading-6 text-secondary-500">Reach out to us for any queries</p>
        </div>
        <div className="grid lg:grid-cols-3 items-center bg-inherit h-full content-center">
        <div className='col-span-1 content-center'>
                ...
                <div className='col-span-2 content-center'>
                    <div className="grid sm:grid-cols-2 gap-2 z-20 relative lg:left-16 max-lg:mb-8">
                        <div className="flex flex-col items-center justify-center rounded w-[90%] sm:w-[80%] mx-auto h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-orange-600" viewBox="0 0 512 512">
                            ...
                            <h4 className="text-[#333] text-base font-extrabold mt-4">Kenya</h4>
                            <p className="text-sm tect-gray-400 mt-2"> P.o.box Kasarani Mwiki Road, G.P.O Nairobi</p>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded w-[90%] sm:w-[80%] mx-auto h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-orange-600" viewBox="0 0 473.806 473.806">
                            ...
                            <h4 className="text-[#333] text-base font-extrabold mt-4">Call us</h4>
                            <p className="text-sm tect-gray-400 mt-2">+254 714905613</p>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded w-[90%] sm:w-[80%] mx-auto h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-orange-600" viewBox="0 0 32 32">
                            ...
                            <h4 className="text-[#333] text-base font-extrabold mt-4">Chat to us</h4>
                            <p className="text-sm tect-gray-400 mt-2">hello@ajirapay.finance</p>
                        </div>
                        <div className="flex flex-col items-center justify-center rounded w-[90%] sm:w-[80%] mx-auto h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-orange-600" viewBox="0 0 100 100">
                            ...
                            <h4 className="text-[#333] text-base font-extrabold mt-4">Fax</h4>
                            <p className="text-sm tect-gray-400 mt-2">+254 714905613</p>
                        </div>
                ...
                {/* <div className="lg:col-span-2 bg-orange-600 rounded sm:p-10 p-4 z-10">
                    <h2 className="text-3xl text-white text-center font-extrabold mb-6">Contact Us</h2>
                    <form>
                        <div className="max-w-sm mx-auto space-y-4">
                            <input type='text' placeholder='Name'
                                className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none" />
                            <input type='email' placeholder='Email'
                                className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none" />
                            <input type='email' placeholder='Phone No.'
                                className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none" />
                            <textarea placeholder='Message' rows={6}
                                className="w-full bg-gray-100 rounded px-6 text-sm pt-3 outline-none"></textarea>
                            <button type='button'
