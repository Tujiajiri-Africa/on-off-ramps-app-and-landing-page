...
export function FooterV2(){
    ...
    return (<>
        <div className="bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50">
   
   <footer className="bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 relative w-[98%] mx-auto h-screen flex flex-col justify-center items-center overflow-hidden p-10">
   <div className="mx-auto w-full p-4 py-6 lg:py-8 2xl:w-[80%]">
       <div className="md:flex md:justify-between">
         <div className="mb-6 md:mb-0">
             <a href="#" className="flex items-center">
                 ...
                 /> */}
                   ...
                   className='gap-10'
                 />
                 <span className="self-center text-2xl font-semibold whitespace-nowrap text-slate-900 dark:text-white">Ajira Pay Finance</span>
                 {/* <span>
                   Third Court Street
                 </span> */}
             </a>
         ...
         <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
             ...
             <div>
                 <h2 className="mb-6 text-sm font-semibold  uppercase text-slate-900 dark:text-white">Products</h2>
     ...
     <div className="sm:flex sm:items-center sm:justify-between">
         ...
         <div className="flex mt-4 sm:justify-center sm:mt-0">
             ...
             <a href="https://discord.com/invite/Ts7CEYp8ss" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
             ...
             <a href="https://twitter.com/ajiraPayDefi" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
             ...
             <a href="https://github.com/Tujiajiri-Africa" target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
