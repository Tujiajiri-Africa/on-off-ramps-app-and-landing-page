   ...
   <div className="mx-auto w-full p-4 py-6 lg:py-8 2xl:w-[80%]">
     ...
     <div className="sm:flex sm:items-center sm:justify-between">
         ...
         <div className="flex mt-4 sm:justify-center sm:mt-0">
             ...
             <a href="https://discord.com/invite/Ts7CEYp8ss" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
             ...
             <a href="https://twitter.com/ajiraPayDefi" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
             ...
             <a href="https://github.com/Tujiajiri-Africa" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
